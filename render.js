...
const renderRestaurant = () => {
    ...
    document.getElementById('minimum-not-reached-label').innerHTML = 'Unfortunately you cant order yet.' + restaurant.name + '  only delivers from a minimum order value of ' + dressUpPrice(restaurant.minimumOrderValue) + ' (Delivery costs).';
